...
public class Main {
    public static void main(String[] args) {
        ...
        invoiceApplication.main(args);



        DbContext context = new DbContext();
        context.flipIDScaling();
        System.out.println("Ashton Torgerud's 2742 Ex1c1: Composte Invoice Class:");
        GDate date1 = new GDate(2019, 9, 1);
        System.out.println("lineItem1 = " + date1);
        GDate date2 = new GDate(2019, 9, 11); //why on 9/11? ;-;
        ...
        System.out.println(lineItem3);
        LineItem lineItem4 = new LineItem(1000, "2019 September rent");
        System.out.println(lineItem4);
        ...
        for (int i = 0; i < lineItems.size(); i++) {
            System.out.println(lineItems.get(i).TwoString());
        }
        ...
        for (int i = 0; i < lineItems.size(); i++) {
            System.out.println("\tlineItem " + i + " = " + lineItems.get(i).TwoString());
        }
