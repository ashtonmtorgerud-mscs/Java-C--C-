...
class SensorTest {
    ...
    @BeforeEach
    void setUp() {
        sensor = new Sensor(2,1,1,"Heat register");
    ...
    void findMinReading() {
        int minValue = this.sensor.findMinReading();
        assertEquals(20 , minValue);
    }

    @org.junit.jupiter.api.Test
    void findMaxReading() {
        int minValue = this.sensor.findMaxReading();
        assertEquals(39 , minValue);
    }

    @org.junit.jupiter.api.Test
    void findMinReadingIndex() {
        int maxValue = this.sensor.findMaxReadingIndex(10, 50);
        assertEquals(35 , maxValue);
    }

    @org.junit.jupiter.api.Test
    void findMaxReadingIndex() {
        int maxValue = this.sensor.findMaxReadingIndex(0, this.sensor.getSensorReadings().size() - 1);
        assertEquals(39 , maxValue);
    }

    @org.junit.jupiter.api.Test
    void CountTotalReadings() {
        int maxValue = this.sensor.getSensorReadings().size();
        assertEquals(118 , maxValue);
    }


    @org.junit.jupiter.api.Test
    void CeilingIndexOutofBounds() {
        assertThrows(Exception.class, () -> {int maxValue = this.sensor.findMaxReadingIndex(0, 911115);});
    }

    @org.junit.jupiter.api.Test
    void FloorIndexOutofBounds() {
        assertThrows(Exception.class, () -> {int maxValue = this.sensor.findMaxReadingIndex(-5, 15);});
    }
