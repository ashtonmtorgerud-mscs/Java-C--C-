...
public class Apartment {
    ...
    public Apartment() {
//        this.apartmentId = 0;
        this.apartmentId = dbContext.getApartmentID();
        this.apartmentNum = "";
        this.squareFeet = 0;
        this.bathrooms = 0;
        this.price = 0.0;
    ...
    public Apartment(int apartmentId, String apartmentNum, int squareFeet, int bathrooms, double price, Person administrator, Person tenant) {
...
//    Removed String Apartment Location because IDK why it was there
    public Apartment(int apartmentId, String apartmentNum, int squareFeet, int bathrooms, double price) {
        this.apartmentId = apartmentId;
        this.apartmentNum = apartmentNum;
        this.squareFeet = squareFeet;
        this.bathrooms = bathrooms;
    ...
    public String toString(){
        String returnString = "Apartment:  " + Integer.toString(apartmentId);
        return returnString;
    }
